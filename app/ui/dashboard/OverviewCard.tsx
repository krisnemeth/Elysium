...
export default function OverviewCard({
  ...
  return (
    <div className='w-full h-full border border-slate-300/50 bg-black rounded-xl bg-clip-padding backdrop-filter backdrop-blur-lg shadow-md shadow-black p-2'>
