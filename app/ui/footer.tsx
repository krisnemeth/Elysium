export default function Footer() {
  ...
  return (
    <div className='hidden md:block z-10 lg:flex w-full px-10 py-4 bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-100 fixed bottom-0'>
