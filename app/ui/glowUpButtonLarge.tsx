...
export default function GlowUpButtonLarge({
  ...
  return (
    <div className='relative group'>
      <div className='absolute -inset-0.5 bg-gradient-to-r from-rose-600 to-violet-600 dark:from-zinc-700 dark:to-neutral-500 rounded-lg blur-md opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 w-full xl:max-w-96'></div>
