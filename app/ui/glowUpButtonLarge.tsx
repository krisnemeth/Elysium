...
export default function GlowUpButtonLarge({
  ...
  return (
    <div className='relative group'>
      ...
      <button className='relative flex items-center justify-center bg-black px-4 py-2 text-slate-300 rounded-lg group-hover:text-slate-100 transition duration-200 ease-in-out w-44 xl:w-80'>
