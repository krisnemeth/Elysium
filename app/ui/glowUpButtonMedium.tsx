...
export default function GlowUpButtonMedium({
  ...
  return (
    <Link href={buttonHref}>
      <div className='relative group mt-4 border border-slate-300/50 rounded-md'>
        ...
        <button className='relative flex items-center justify-center bg-black px-2 py-1 text-slate-300 rounded-lg group-hover:text-slate-100 transition duration-200 ease-in-out xl:w-full'>
