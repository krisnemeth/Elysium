...
export default function Features() {
  return (
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-10 md:mb-20 w-full py-4 px-10'>
        <GlowUpCard
          image={
            <Image
          ...
          description='Build your vampires with ease using our intuitive character
        ...
        <GlowUpCard
          ...
          description="Take Elysium with you wherever you go. Our mobile and tablet-friendly interface ensures you're never far from your character, allowing you to dive into the darkness at a moment's notice. Two gorgeous color themes to choose from, Classic Masquerade and Neon Nights."
        />
        <GlowUpCard
          image={
            <Image
          ...
          description="Forgot your dice? No problem. You'll have access to a dice roller on you dashboard ensuring you're always ready to roll, no matter where you are. Courtesy of the incredible developer and long-time friend, Gabor Pfalzer."
        />
      </div>
      ;
    </>
