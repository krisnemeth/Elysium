...
export default function Navbar() {
  return (
    <div className='w-full absolute'>
      <div className='flex justify-between p-2 bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-60 mx-96 mt-2'>
        <div className='z-50 relative flex items-center '>
          <div className='logo z-50 flex items-center drop-shadow-[0_0_0.3rem_#ffffff70] text-slate-300 ml-4 divide-x-2 '>
            <GiDove className='text-2xl mb-2 mr-4' />
            <Link href='/' className=''>
              <p className='relative text-2xl ml-4'>Elysium</p>
            </Link>
          </div>
        </div>
        <div className=''>
            ...
            <ul className='z-50 flex items-center'>
              {/* <li className='z-50 mx-2.5 lg:inline-block '>
                <div className='relative group'>
                  <div className='absolute -inset-0.5 bg-gradient-to-r from-rose-600 to-violet-600 rounded-lg blur-md opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 w-36'></div>
