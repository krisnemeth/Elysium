...
export default function Navbar() {
  return (
    <div className='w-full fixed z-50'>
      <div className='flex justify-between p-2 bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-60 xl:mx-96 md:mt-6'>
              ...
              <div className='relative group'>
                ...
                <button className='relative flex items-center justify-center bg-black px-4 py-2 text-slate-300 rounded-lg group-hover:text-slate-100 transition duration-200 ease-in-out w-36'>
                  <span className='text-sm md:text-xl'>
                    Log In{' '}
                    <MdArrowForward className='inline text-sm md:text-xl mb-1' />
                  </span>
                </button>
              </div>
            </li>
