...
export default function Navbar() {
  return (
    <div className='w-full fixed z-50'>
      <div className='flex justify-between p-2 bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-60 md:mx-36 lg:mx-72 xl:mx-96 md:mt-1 lg:mt-2 xl:mt-3 h-14 lg:h-16'>
        <div className='z-50 relative flex items-center'>
          <div className='logo z-50 flex items-center drop-shadow-[0_0_0.3rem_#ffffff70] text-slate-300 ml-4 divide-x-2 '>
            <GiDove className='text-sm md:text-xl mb-1 mr-2 md:mr-4' />
            <Link href='/' className=''>
              <p className='relative text-sm md:text-xl ml-2 md:ml-4'>
                Elysium
              </p>
            </Link>
          </div>
        ...
        <nav className='lg:block h-full mr-4'>
          <ul className='z-50 flex items-center mt-2'>
